...
Settings _setSettings(Settings settings, SettingsLoadedAction action) {
  print('_setSettings - SettingsLoadedAction');

  return action.settings;
}

Settings _toggleShortcutsEnabledSetting(
    Settings settings, ShortcutsEnabledSettingToggledAction action) {
  print('_toggleShortcutsEnabledSetting - ShortcutsEnabledSettingToggleAction');

  return settings.copyWith(isShortcutsEnabled: !settings.isShortcutsEnabled);
}

Settings _toggleDarkThemeUsedSetting(
    Settings settings, DarkThemeUsedSettingToggledAction action) {
